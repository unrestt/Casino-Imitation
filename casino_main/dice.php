...
<nav id="home-section">
    ...
    <!-- -----------------------gra--------------------------- -->
    <main>
        <section id="dice-game-section">
            <div class="header-main">
                <i class="fa-solid fa-dice"></i>
                <h1>Dice</h1>
            </div>
            <div class="dice-container">
                <div class="left-panel-pre">
                    ...
                    <div class="input-section">
                        <p>Zysk podczas wygranej</p>
                        <div class="input-display">
                            <p id="actualWin">0$</p>
                        </div>
                    </div>
                    <button name="start" id="start">Postaw</button>
                </div>
                <div class="dice-right-panel">
                    <div id="results-container"></div>
                    <div class="dice-slider">
                        <div class="ranges-width">
                            <div class="range">
                                <p>0</p>
                        ...
                        <div class="grey-input-back">
                            <div class="dark-grey-input-back">
                                <div class="input-width-full">
                                    <div id="result"></div>
                                    <input type="range" name="range" id="range" step="1" min="2" max="98">
                                </div>
                    ...
                    <div class="bottom-right-panel">
                        ...
                        <div class="bottom-input-container">
                            <p>Mnożnik</p>
                            <input type="number" id="mnoznik" value="1.9898">
                            <i class="fa-solid fa-xmark"></i>
                        </div>
                        <div class="bottom-input-container reverse" id="reverse">
                            <p id="reverse-text">Poniżej</p>
                            <input type="text" id="above" value="50" readonly>
                            <i class="fa-solid fa-backward"></i>
                        </div>

                        <div class="bottom-input-container">
                            <p>Szanse</p>
                            <input type="number" id="chance" value="50">
